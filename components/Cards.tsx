...
export const FeaturedCard = ({ item, onPress }: Props) => {
  return (
    ...
    >
      ...
      <View className="flex flex-row items-center bg-white/90 px-3 py-1.5 absolute top-5 right-5 rounded-full">
...
export const Card = ({item, onPress}:Props) => {
  return(
    <TouchableOpacity onPress={onPress} className="flex-1 w-full my-3 px-4 py-3 rounded-lg bg-white shadow-lg shadow-black-300/80 relative">
